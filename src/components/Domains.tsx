        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-16 animate-fade-up">
            <h2 className="font-heading font-bold text-3xl lg:text-4xl text-gray-dark mb-6">
              <EditableText
                textKey="domains.header.title1"
                defaultValue={getSiteText('domains', 'header', 'title1', 'Nos Domaines')}
                className="inline"
                as="span"
              />{' '}
              <EditableText
                textKey="domains.header.title2"
                defaultValue={getSiteText('domains', 'header', 'title2', "d'Intervention")}
                className="text-gradient-orange inline"
                as="span"
              />
            </h2>
            <EditableText
              textKey="domains.header.description"
              defaultValue={getSiteText('domains', 'header', 'description', 'Nous adaptons nos solutions aux spécificités de chaque secteur pour offrir des infrastructures fiables, durables et adaptées aux besoins de nos clients.')}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
            {domaines.map((domaine, index) => {
              ...
              return (
                <div 
                  key={domaine.id}
                  className="card-elegant bg-white group hover:shadow-hover animate-scale-in"
          ...
          <div className="bg-gradient-hero rounded-2xl p-8 lg:p-12 text-center text-white animate-fade-up">
            <div className="max-w-4xl mx-auto">
              <EditableText
                textKey="domains.experience.title"
                defaultValue={getSiteText('domains', 'experience', 'title', "Plus de 30 ans d'expertise à votre service")}
                className="font-heading font-bold text-2xl lg:text-3xl mb-4"
                as="h3"
              />
              <EditableText
                textKey="domains.experience.description"
                defaultValue={getSiteText('domains', 'experience', 'description', "De la Tunisie à l'Afrique, nous avons développé une expertise reconnue dans tous les secteurs de l'ingénierie électrique et du BIM.")}

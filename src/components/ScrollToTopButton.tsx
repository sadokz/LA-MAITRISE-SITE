...
const ScrollToTopButton: React.FC = () => {
  ...
  return (
    <Button
      onClick={scrollToTop}
      className={cn(
        "fixed bottom-6 right-6 z-40 p-0 w-14 h-14 rounded-full bg-primary hover:bg-primary/90 text-white shadow-lg transition-all duration-300 flex items-center justify-center",
